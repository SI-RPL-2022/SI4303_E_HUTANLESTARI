...
@section('content')
    <div class="img img-fluid overflow-hidden" style="max-height: 350px">
        <img class="w-100" src="{{asset('gmbr/back1.png')}}" alt="">
    </div>
            ...
            <div class="d-flex justify-content-center">
                <div class="card w-50 mx-3">
                    <div class="card-header">
                        ...
                        <form action="{{route('searchDonasi')}}" method="post" class="d-flex">
                            @csrf
                            @method('post')
                    ...
                    <div class="card-body" style="height: 200px ; overflow: scroll">
                        @foreach($volun as $t)
                            <div class="d-flex flex-wrap pl-5 mt-2">
                                ...
                                <div class="ml-3">
                                    <h5>{{$t->nama_depan}}</h5>
                                    <p class="text-black-50">Telah Berabung Tanggal {{$t->created_at}}</p>
                                    <hr>
                                </div>
