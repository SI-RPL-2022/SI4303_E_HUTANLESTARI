        ...
        <div class="d-flex">
            ...
            <div class="col-7 p-3">
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{route('admin.verifcampaign')}}" class="btn btn-success text-black mx-1"> Verifikasi  <br> Campaign</a>

                    <a href="{{route('admin.verifblog')}}" class="btn btn-success text-black mx-1"> Verifikasi  <br> Blog</a>
                </div>
