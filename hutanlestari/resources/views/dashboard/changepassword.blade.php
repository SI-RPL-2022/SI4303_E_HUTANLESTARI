                    ...
                    <div class="card-body p-2">
                        <form action="{{route('changepassword')}}" method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="password" name="password_baru" id="password" class="form-control" required>

                            </div>

                            <div class="form-group mb-3">
                                <label for="nama">Konfirmasi Password Baru</label>
                                <input type="password" name="password_baru" id="confirmpassword" class="form-control" required>
                            </div>



                            <button class="btn btn-success w-100" id="submit" type="submit" disabled>Reset Password</button>
