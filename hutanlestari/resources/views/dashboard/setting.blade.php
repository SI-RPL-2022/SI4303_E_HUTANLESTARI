        ...
        <div class="d-flex">
            ...
            <div class="col-7 p-3">
                ...
                <div class="d-flex mt-2">
                    <a href="{{route('settings')}}" class="btn btn-success mx-2">Profil</a>
                    <a href="{{route('changepassword')}}" class="btn btn-success mx-2">Password</a>
                </div>

                <div class="card rounded shadow-sm bg-card mt-3">
                    <div class="card-body p-2">
                        <form action="{{route('settingspost' , ['id'=>Auth::user()->detail['id']])}}" method="post">
                            @csrf
                            @method('POST')
                            <div class="form-group mb-3">
                                <label for="nama">Nama Lengkap</label>
                                <input type="text" name="nama_lengkap" class="form-control" value="{{Auth::user()->detail['nama_lengkap']}}">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                <label for="nama">Nomer Telephone/Wa</label>
                                <input type="text" name="no_hp" class="form-control" value="{{Auth::user()->detail['no_hp']}}">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="tanggal_lahir" class="form-control"  value="{{Auth::user()->detail['tanggal_lahir']}}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="nama">Jenis Kelamin</label>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jk" id="exampleRadios1" value="laki laki" @if(Auth::user()->detail['jenis_kelamin'] == "laki laki") checked @endif>
                                    <label class="form-check-label" for="exampleRadios1">
                                        Laki - Laki
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jk" id="exampleRadios2" value="perempuan " @if(Auth::user()->detail['jenis_kelamin'] == "perempuan") checked @endif>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="kota" class="form-control" value="{{Auth::user()->detail['kota']}}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="nama">Instagram</label>
                                <input type="text" name="instagram" class="form-control" value="{{Auth::user()->detail['instagram']}}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="nama">Twitter</label>
                                <input type="text" name="twitter" class="form-control" value="{{Auth::user()->detail['twitter']}}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="nama">Facebook</label>
                                <input type="text" name="facebook" class="form-control" value="{{Auth::user()->detail['facebook']}}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="desc">Bio</label>
                                <textarea name="bio" class="form-control" style="height: 130px"> {{Auth::user()->detail['bio']}}</textarea>
                            </div>
