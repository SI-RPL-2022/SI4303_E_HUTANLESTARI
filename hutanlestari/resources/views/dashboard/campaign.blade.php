...
@section('content')
    ...
    <div class="card mt-3 p-3 mr-4 bgdashijo shadow">
        <div class="card-head bgdashijo rounded ">
            <h4 class="text-black text-center p-2 bg-white rounded" > Campaign Yang Di Ikuti</h4>
        </div>

        <div class="card-body bgbawahdash rounded " >
            <div class="d-flex justify-content-end">  <a href="{{route('campaign.index')}}" class="btn btn-success ">Lihat Campaign</a> </div>
            <?php $x=0?>
            <h4>List Campaign</h4>
